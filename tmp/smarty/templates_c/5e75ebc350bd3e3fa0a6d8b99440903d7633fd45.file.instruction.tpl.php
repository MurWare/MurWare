<?php /* Smarty version Smarty-3.1.6, created on 2019-04-10 05:00:45
...
<div class="auth-block auth-block_instruction flex flex-column card-style __modalInst" data-id="1" style="height: 630px">
	...
	<span class="auth-block__info auth-block__info_instruction f-medium t-6">
		...
		1. Все что нужно для работы чита вы можете - скачать <a href="//vk.com/topic-153586792_39000470" target="_blank" class="auth-block__agree t-6">здесь</a> <br>
		2. Советуем отключить Антивирус/Брандмауэр <br>
		3. Советуем обновить драйвера видео-карты <br>
	</span>
</div>
...
<div class="auth-block auth-block_instruction flex flex-column card-style __modalInst" data-id="3" style="height: 630px">
	...
	3. Bad credentials/Wrong Hwid - Если Вы не можете зайти в лоадер, значит у вас сменился HWID или неверные данные. Сбросить пароль и привязку вы можете в <a href="/profile/" target="_blank" class="auth-block__agree t-6">профиле</a>
	</span>
</div>
