<?php /* Smarty version Smarty-3.1.6, created on 2019-05-12 14:19:02
...
<main class="main main_account flex j-spacebetween flex-wrap">
 ...
 - <?php echo $_smarty_tpl->tpl_vars['Me']->value['login'];?>
	...
	<form class="aside card-style flex flex-column j-center a-center">
		...
		<a class="aside__button aside__button_3 f-medium card-style t-6" href="/admin/">Админ панель</a>
		<?php }?>
		<a class="aside__button aside__button_1 f-medium card-style __tabLink t-6 aside__button_active" data-id="0">Профиль</a>
		<a class="aside__button aside__button_8 f-medium card-style __tabLink t-6" data-id="ref-sys">Реф. система</a>
		<a class="aside__button aside__button_9 f-medium card-style __tabLink t-6" data-id="ref-top">Топ рефереров</a>
		<a class="aside__button aside__button_2 f-medium card-style __tabLink t-6" data-id="reset-binding">Сброс привязки</a>
		<a class="aside__button aside__button_3 f-medium card-style  t-6" href="//vk.com/im?media=&sel=-153586792" target="_blank">Тех. Поддержка</a>
		<a class="aside__button aside__button_4 f-medium card-style t-6" href="//vk.com/topic-153586792_39152338" target="_blank">Отзывы</a>
		<a href="/payment/" class="aside__button aside__button_5 f-medium card-style t-6">Купить чит</a>
		<a class="aside__button aside__button_6 f-medium card-style t-6">Радар</a>
		<a class="aside__button aside__button_7 f-medium card-style t-6" href="/authorization/logout/">Выход</a>
	</form>
	...
	<div class="inside flex card-style a-center j-center" style="height: auto;">
		...
		<form class="inside__account-content flex a-center j-center flex-column __tab" style="margin-left: auto;margin-right:auto;text-align:center;" data-id="ref-sys">
			...
			<span class="f-medium">Если ваш друг купит приватный чит AURORA по вашей ссылке,
			...
			<div class="account-content__setting flex a-center j-spacebetween flex-wrap" style="width: 80%;">
				...
				<input type="text" style="width: auto !important; height:50px !important; margin-bottom:20px !important;" class="account-content__input card-style account-content__input_reset message" readonly value="https://aurora-project.ru/?referal=<?php echo $_smarty_tpl->tpl_vars['Me']->value['login'];?>
" id="referal_copy_input">  <a class="account-content__button card-style t-6 account-content__button_data f-medium" id="copy_ref">Скопировать</a>
			...
			<span class="f-medium">При покупке приватного чита AURORA по реферальной ссылке,
		...
		<form class="inside__account-content flex a-center j-center flex-column __tab" style="margin-left: auto;margin-right:auto;text-align:center;" data-id="ref-top">
			...
			<span class="f-medium"><a href="https://vk.com/aurorareborn?w=wall-153586792_32585">Подробнее о конкурсе...</a></span>
			<br>
...
<footer class="footer flex a-center">
	...
	<div class="footer__social flex a-center">
		<a href="//www.youtube.com/channel/UCHeuRvHUKsw7BApFe_Pf-kg" class="social__link social__link_youtube t-6" target="_blank"></a>
