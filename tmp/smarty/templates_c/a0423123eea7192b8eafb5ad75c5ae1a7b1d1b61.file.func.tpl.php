<?php /* Smarty version Smarty-3.1.6, created on 2019-04-13 00:26:49
...
cocoen.min.css">
	<style>
		...
		.cocoen-drag {
			width: 5px;
			background: -moz-linear-gradient(to top, #4b68d2 0%, #7290f7 100%);
			background: -webkit-linear-gradient(to top, #4b68d2 0%,#7290f7 100%); 
			background: linear-gradient(to top, #4b68d2 0%,#7290f7 100%);
		}
...
func-modal__img-2.png" alt="" class="func-modal__img">
	...
	<div class="func-modal __funcModal card-style f-medium" data-id="3" style="max-height: 46.5%;">
		<img src="<?php echo $_smarty_tpl->tpl_vars['IMG']->value;?>
func-modal__img-3.png" alt="" class="func-modal__img">

		<span class="func-modal__info f-medium">Выбор зоны наведения</span>
		<span class="func-modal__info f-medium">Настройка частей тела</span>
		<span class="func-modal__info f-medium">Гибкая настройка под разные типы оружий</span>
		<span class="func-modal__info f-medium">Автоматическая стрельба / прицеливание</span>
		<span class="func-modal__info f-medium">Настройка настоящих и фейковых углов антиаимов</span>
	</div>
...
func-modal__img-4.png" alt="" class="func-modal__img">
		...
		<span class="func-modal__info f-medium">Пользователи AURORA видят ваши скины</span>
	</div>
...
withhack.png" alt="">
	...
	<div class="func f-medium __funcButton func_3 t-6 card-style" data-id="3">
		RAGEBOT
	</div>
