<?php /* Smarty version Smarty-3.1.6, created on 2019-04-11 19:02:45
...
<main class="main flex j-center a-center">
	...
	<form class="flex flex-wrap container a-center j-center container" data-id="youtube">
		...
		<div class="price-info flex j-spacebetween a-center" style="margin-top: 10px;">
			...
			<div class="price-info__topay"><span class="__priceTopay f-medium"><?php echo intval(149*(100-$_smarty_tpl->tpl_vars['Referer']->value['ref_discount'])/100);?>
</span> <br> Рублей</div>
