<?php /* Smarty version Smarty-3.1.6, created on 2019-04-10 09:24:06
...
3. Подписка  <br>
Вы можете обращаться в нашу техническую поддержку, в любой момент через сообщения группы ВКонтакте ( https://vk.com/aurorareborn ). Подписка «навсегда» будет работать до тех пор, пока сайт и ПО AURORA продолжат своё существование.  <br>
...
8. Согласие может быть отозвано субъектом персональных данных или его представителем путем направления обращения на электронный адрес admin@aurora-project.ru.  <br>
9. Настоящее согласие действует все время до момента прекращения обработки персональных данных.
 <br>
...
<footer class="footer flex a-center">
	...
	<div class="footer__social flex a-center">
		...
		<a href="//vk.com/auroracheat" class="social__link social__link_vk t-6" target="_blank"></a>
