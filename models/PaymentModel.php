<?php
    ...
    class FreeKassa extends dbc
    {
		...
		public function days_referal(){
			$array = array(
                array( "buyer" => 0, "referer" => 0.5, "price" => 80, "days" => 7 ),
                array( "buyer" => 1, "referer" => 3, "price" => 149, "days" => 30 ),
                array( "buyer" => 3, "referer" => 7 , "price" => 249, "days" => 60 ),
                array( "buyer" => 4, "referer" => 11 , "price" => 399, "days" => 90 ),
                array( "buyer" => 10, "referer" => 23 , "price" => 749, "days" => 180 ),
                array( "buyer" => 20, "referer" => 50, "price" => 1299, "days" => 360 ),
                array( "buyer" => 0, "referer" => 60 , "price" => 1399, "days" => 9999 ),
            );
            return $array;
		}
        ...
        public function getURL(){
            ...
            // $this->price > 119 ||
            $link = 'http://www.free-kassa.ru/merchant/cash.php?'.http_build_query($query).$referal;
